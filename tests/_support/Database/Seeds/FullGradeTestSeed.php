...
class FullGradeTestSeed extends Seeder {
    ...
    private function insertTPI() {
        ...
        $this->db->table('grade')->insert($TPIGrade);
    }

    private function insertTPA() {
        $grade = [
            'grade' => 5.0,
            'fk_teaching_module' => null,
            'fk_user_course' => USER_COURSE_DEV_ID,
            'fk_teaching_subject' => 10, // tpa subject dev
            'date' => '2024-08-22',
            'is_school' => 0,
            'archive' => null
        ];
    ...
    private function insertExam() {
        $grade = [
            ...
            'fk_teaching_module' => null,
            'fk_user_course' => USER_COURSE_DEV_ID,
            'fk_teaching_subject' => 11, // exam subject course plan dev
            'date' => '2024-08-22',
            'is_school' => 0,
            'archive' => null
        ];
    ...
    private function insertECG() {
        $grades = [
            [
            'grade' => 6.0,
            'fk_teaching_module' => null,
            'fk_user_course' => USER_COURSE_DEV_ID,
            'fk_teaching_subject' => 9, // ecg subject course plan dev
            'date' => '2024-08-22',
            'is_school' => 0,
            'archive' => null
            ],
