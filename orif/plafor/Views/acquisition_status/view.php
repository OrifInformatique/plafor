...
<div class="container">
    ...
    <div class="row">
		...
		<?php if($_SESSION['user_access'] >= config('\User\Config\UserConfig')->access_lvl_trainer): ?>
		    <div class="col mb-2">
		        <a href="<?= base_url('plafor/apprentice/add_comment/'.$acquisition_status['id']); ?>" class="btn btn-primary">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <a href="<?= base_url('plafor/apprentice/add_comment/'.$acquisition_status['id'].'/'.$comment['id'])?>">
                                    <?= $comment['comment']; ?>
                                </a>
                            </td>
