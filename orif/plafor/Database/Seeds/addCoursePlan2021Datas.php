...
class addCoursePlan2021Datas extends Seeder{
    public function run(){
        $course_plans = array(
            ...
            array('id' => '7','formation_number' => '88614','official_name' => "Informaticienne d'entreprise, Informaticien d'entreprise avec CFC",'date_begin' => '2021-08-01','archive' => '2021-08-01')
        );
