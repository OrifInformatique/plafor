...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 26 mai 2020 à 16:02
...
--
-- Structure de la table `acquisition_statut`
--

CREATE TABLE `acquisition_statut` (
  `id` int(11) NOT NULL,
...
--
-- Index pour la table `acquisition_statut`
--
ALTER TABLE `acquisition_statut`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `acquisition_statut`
--
ALTER TABLE `acquisition_statut`
...
--
-- Contraintes pour la table `acquisition_statut`
--
ALTER TABLE `acquisition_statut`
