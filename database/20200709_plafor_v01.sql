...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 09 juil. 2020 à 13:18
...
(42, 21, 'Choisir et mettre en service une place de travail utilisateur', 'A1', 'Analyse des valeurs utiles, déroulement systématique,\r\nfaire des checklists, technique commerciale, méthode durable de travail (économiquement, écologiquement, socialement).', 'Orientation client, communication écrite et orale.', 'Conscience de la responsabilité, fiabilité, auto-réflexion critique.', 0),
(43, 21, 'Choisir et mettre en service des systèmes serveurs', 'A2', 'Analyse des valeurs utiles, déroulement systématique, faire des\r\nchecklists, travail durable (économiquement, écologiquement,\r\nsocialement).', 'Orientation client, communication écrite et orale.', 'Auto-réflexion critique.', 0),
(44, 21, 'Choisir des composants réseau et les mettre en service', 'A3', 'Analyse des valeurs utiles, déroulement systématique, faire des\r\nchecklists, technique commerciale, méthode durable de travail\r\n(économiquement, écologiquement, socialement).', 'Communication écrite et orale, empathie, travail en groupe,\r\nlangage adapté au public cible.', 'Auto-réflexion critique, capacités d‘abstraction.', 0),
(45, 22, 'Planifier et installer des réseaux ainsi que leur topologie', 'B1', 'Déroulement analytique, principe de Pareto, techniques de visualisation, diagrammes, techniques de décision.', 'Faire des entretiens professionnels en anglais.', 'Méthode précise de travail, conscience de la responsabilité,\r\ncapacités d’abstraction.', 0),
(46, 22, 'Planifier et assurer la sécurité réseau ainsi que l’accès distant', 'B2', 'Déroulement analytique, principe de Pareto.', 'Reconnaître et classer les besoins en sécurité du client.', 'Travail précis, conscience de la responsabilité.', 0),
(47, 22, 'Surveiller des réseaux et garantir leur sécurité et leur capacité de fonctionnement', 'B3', 'Agir de manière préventive.', 'Conscience de la hiérarchie.', 'Discrétion (comportement avec des données confidentielles), fiabilité, précision.', 0),
(48, 22, 'Planifier, installer et exploiter des systèmes de sauvegarde de données en réseau', 'B4', 'Agir de manière préventive.', '', 'Discrétion (comportement avec des données confidentielles), fiabilité, précision, éthique, discrétion, secret professionnel.', 0),
(49, 23, 'Planifier, mettre en œuvre des services d’annuaires et des autorisations', 'C1', 'Techniques d’interrogation.', 'Empathie.', 'Comprendre et interpréter des documents anglais.', 0),
(50, 23, 'Mettre en service et configurer les services étendus des serveurs', 'C2', 'Techniques d‘entretiens, pensées préventive et systématique,\r\nconsidération globale, remise en question systématique.', 'Travail en groupe.', 'Travail patient et auto-critique, sens de la qualité, auto-réflexion.', 0),
(51, 23, 'Mettre en service et configurer des services de communication ainsi que de soutien des travaux de groupe (groupeware)', 'C3', 'Techniques d’entretien, pensée systématique et préventive,\r\nconsidération de l’ensemble, remise en question systématique.', 'Travailler en groupe.', 'Travail patient et auto-critique, sens de la qualité, auto-réflexion.', 0),
(52, 23, 'Élaborer et mettre en œuvre des concepts de sécurité des données, de sécurité des systèmes et d’archivage', 'C4', 'Actions préventives.', 'Conseil.', 'Penser et travailler de manière disciplinée, comportement dans les situations de stress.', 0),
(53, 23, 'Offrir des services via le réseau en prenant des mesures de sécurité', 'C5', 'Techniques d’entretien, pensée systématique et préventive,\r\nconsidération de l’ensemble, remise en question systématique.', 'Travailler en groupe.', 'Travail patient et auto-critique, sens de la qualité, auto-réflexion.', 0),
(54, 24, 'Assurer la maintenance de réseaux et les développer', 'D1', 'Déroulement systématique, faire des checklists, technique commerciale, méthode durable de travail (économiquement, écologiquement, socialement).', '', 'Précision, fiable, actions attentives.', 0),
(55, 24, 'Assurer la maintenance et administrer des serveurs', 'D2', 'Pensée systématique et préventive, considération de l’ensemble, remise en question systématique, travail durable\r\n(économiquement, écologiquement, socialement).', 'Travail en groupe, entretien professionnel en anglais.', 'Travail patient et autocritique, conscience de la qualité, auto-réflexion, éthique, discrétion, discipline.', 0),
(56, 24, 'Assurer la maintenance et administrer les équipements des utilisateurs', 'D3', 'Pensée systématique et préventive, considération de l’ensemble, remise en question systématique.', 'Travail en groupe, comportement diplomatique avec les utilisateurs.', 'Travail patient et autocritique, conscience de la qualité, auto-réflexion.', 0),
(57, 24, 'Enregistrer, standardiser et automatiser des processus TIC', 'D4', 'Déroulement structuré et orienté objectif, pensée et action préventive.', 'Conseil, comportement dans des situations de stress.', 'Penser et travailler de manière disciplinée.', 0),
(58, 24, 'Planifier, mettre en service et appliquer des systèmes de déploiement pour des applications', 'D5', 'Pensée préventive.', 'Appliquer l’anglais oralement et par écrit.', 'Réflexion, discipline et capacité d‘endurance.', 0),
(59, 25, 'Préparer, structurer et documenter des travaux et mandats de manière systématique et efficace', 'E1', 'Déroulement structuré, déroulement systématique selon checklist, documentation des travaux.', 'Travail en groupe, prêt à aider, intérêt global, tenir une conversation en langue étrangère, compréhension des rôles.', 'Fiabilité, bon comportement, capacité élevée de charges, s’identifier à l’entreprise.', 0),
(60, 25, 'Collaborer à des projets', 'E2', 'Déroulement structuré, déroulement systématique selon checklist, documentation des travaux.', 'Travail en groupe, prêt à aider, intérêt global, tenir une conversation en langue étrangère, compréhension des rôles.', 'Fiabilité, bon comportement, capacité élevée de charges, s’identifier à l’entreprise, réfléchir en commun dans le projet.', 0),
(61, 25, 'Dans le cadre de projets, communiquer de manière ciblée et adaptée à l’interlocuteur', 'E3', 'Méthodes de travail, pensée en réseau, techniques de présentation et de ventes.', 'Travail en groupe, communiquer conformément au niveau et aux utilisateurs, comportement respectueux et approprié avec toutes les personnes de contact à tous les niveaux, communication précise.', 'Réflexion, prêt à apprendre, intérêt, capacité de critiques, capacité de résistance.', 0),
(62, 26, 'Installer et configurer des terminaux ICT utilisateurs ainsi que des systèmes d’exploitation et en assurer la maintenance', 'A1', 'Techniques de travail, approche et action interdisciplinaires axées sur les processus, comportement écologique et économique.', 'Capacité à communiquer, aptitude au travail en équipe.', 'Autonomie et responsabilité, résistance au stress, flexibilité, apprentissage tout au long de la vie.', 0),
(63, 26, 'Installer et configurer des applications standard', 'A2', 'Techniques de travail, approche et action interdisciplinaires axées sur les processus, comportement économique.', '', 'Autonomie et responsabilité, résistance au stress, flexibilité, apprentissage tout au long de la vie.', 0),
(64, 26, 'Exécuter et évaluer des tests de fonctionnalité', 'A3', 'Techniques de travail, comportement économique.', '', 'Autonomie et responsabilité.', 0),
(65, 26, 'Mettre en œuvre des scripts d’automatisation', 'A4', 'Techniques de travail, comportement économique.', '', 'Autonomie et responsabilité.', 0),
(66, 27, 'Connecter à l’infrastructure réseau des périphériques compatibles réseau ainsi que des services connexes et résoudre les pannes', 'B1', 'Techniques de travail, approche et actions interdisciplinaires, comportement économique.', 'Capacité à communiquer, aptitude au travail en équipe.', 'Autonomie et responsabilité, résistance au stress, flexibilité, apprentissage tout au long de la vie.', 0),
(67, 27, 'Connecter des terminaux ICT utilisateurs aux prestations de serveur et résoudre les pannes', 'B2', 'Techniques de travail, approche et action interdisciplinaires axées sur les processus, comportement économique.', 'Capacité à communiquer, aptitude au travail en équipe.', 'Autonomie et responsabilité, résistance au stress, flexibilité, apprentissage tout au long de la vie.', 0),
(68, 27, 'Assurer la sécurité des terminaux ICT utilisateurs', 'B3', 'Techniques de travail, approche et action interdisciplinaires axées sur les processus, comportement économique.', 'Capacité à communiquer.', 'Autonomie et responsabilité, résistance au stress, flexibilité, apprentissage tout au long de la vie.', 0),
(69, 28, 'Instruire et soutenir les utilisateurs dans la mise en œuvre des moyens ICT', 'C1', 'Techniques de travail, techniques de présentation, comportement économique.', 'Capacité à communiquer.', 'Capacité à analyser sa pratique, autonomie et responsabilité, résistance au stress, flexibilité.', 0),
(70, 28, 'Élaborer et adapter des modes d’emploi et checklists pour les utilisateurs', 'C2', 'Techniques de travail, approche et action interdisciplinaires axées sur les processus, techniques de présentation, comportement économique.', 'Capacité à communiquer.', 'Autonomie et responsabilité, flexibilité.', 0),
(71, 28, 'Conseiller et soutenir les clients lors de l’acquisition d’appareils terminaux ICT', 'C3', 'Techniques de travail, approche et action interdisciplinaires axées sur les processus, techniques de présentation, comportement économique.', 'Capacité à communiquer, aptitude au travail en équipe.', 'Autonomie et responsabilité, flexibilité.', 0),
(72, 29, 'Traiter les demandes des clients au 1er et 2e niveau du support', 'D1', 'Techniques de travail, approche et action interdisciplinaires axées sur les processus, techniques de présentation, stratégies d’information et de communication, économique.', 'Capacité à communiquer, aptitude au travail en équipe.', 'Autonomie et responsabilité, résistance au stress, flexibilité, apprentissage tout au long de la vie.', 0),
(73, 29, 'Se comporter de manière adéquate avec les clients et l’équipe', 'D2', 'Techniques de travail, stratégies d’information et de communication.', 'Capacité à communiquer, capacité à gérer des conflits, aptitude au travail en équipe.', 'Capacité à analyser sa pratique, autonomie et responsabilité.', 0),
(74, 29, 'Exécuter, selon des méthodes spécifiques, les travaux dans l’environnement ICT et collaborer à des projets', 'D3', 'Techniques de travail, approche et action interdisciplinaires axées sur les processus, stratégies d’information et de communication, comportement économique.', 'Capacité à communiquer, aptitude au travail en équipe.', 'Autonomie et responsabilité, flexibilité.', 0);
